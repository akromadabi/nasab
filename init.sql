...
CREATE TABLE `user_tiers` (
    ...
    `max_banis` INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE `banis` (
    ...
    `show_wa_public` BOOLEAN NOT NULL DEFAULT false,
    `show_birth_public` BOOLEAN NOT NULL DEFAULT false,
    `show_address_public` BOOLEAN NOT NULL DEFAULT false,
    `show_socmed_public` BOOLEAN NOT NULL DEFAULT false,
